jQuery(document).ready(function($) {
  ...
  //***************************
  jQuery('.wawrecipe-user-list li a.fa-recipeping-bag').on("click", function() {
    jQuery('.wawrecipe-notification-box').fadeToggle('slow');
    return false;
  });
  jQuery('html').on("click", function() { jQuery(".wawrecipe-notification-box").fadeOut(); });
...
jQuery(window).on('load', function() {
  var $grid = $('.wawrecipe-menu-filter,.wawrecipe-gallery-filter').isotope({
...
//***************************
jQuery(window).on('load', function() {
  var $grid = $('.wawrecipe-breakfast-manu').isotope({
    itemSelector: '.element-item',
    layoutMode: 'fitRows'
  });
  // filter functions
...
//***************************
jQuery(window).on('load', function() {
  var $grid = $('.wawrecipe-dinner-manu').isotope({
    itemSelector: '.element-item',
    layoutMode: 'fitRows'
  });
  // filter functions
